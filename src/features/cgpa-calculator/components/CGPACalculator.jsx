...
function CGPACalculator() {
  ...
  return (
    ...
    >
      <div className="bg-surface rounded-xl shadow shadow-shadow p-6 flex flex-col gap-8 md:p-8 md:gap-6 w-full">
        <div className="space-y-4">
          {semesters.map((_, index) => (
            ...
            >
              <label htmlFor={`sgpa-${index}`} className="font-semibold">
                Semester {index + 1}
              </label>
      ...
      <div className="flex flex-wrap gap-6 md:gap-8 w-full">
        {[
          ...
          <div
            key={index}
            className="flex-1 p-6 grid content-between gap-6 bg-surface rounded-xl shadow shadow-shadow"
          >
